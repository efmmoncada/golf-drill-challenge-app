...
<View>     
          <Image source={require ('../assets/images/ProgressScreenImg.png')}
...
<Image source ={require ('../assets/images/progressGraph.png')}
...
<View>
    ...
    <View style={styles.button_icons}>
        <TouchableOpacity
          ...
          <Text style={styles.buttonTextStyle_day}>Score: 2 Duration: 1hr. Date: 11/15/22</Text>
 ...
 <TouchableOpacity style={styles.buttonStyle} activeOpacity={0.5}>
          ...
          <Text style={styles.buttonTextStyle_day}>Score: 5 Duration: 2hr. Date: 11/15/22</Text>
        </TouchableOpacity>
